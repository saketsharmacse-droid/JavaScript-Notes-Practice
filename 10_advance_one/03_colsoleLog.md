# Notes
- console log actually mei core JS ka part hi nhi hai.
- actually technically, console aur bahut saari apis toh js ka part hi nhi hote, jaise document aur methods uske, jaise document.getElementById yeh sab core js ka part nhi hai.
- core js mei arithmetic operations, basic function aur loops execution wagera bus rhta hai. 
- yeh sab apis hai, console.log actually mei ek debugger hai, ek browser ka developer tool hai.
- so, there are actually mei injected by the runtime environment , not the core engine. 

- node js bhi ek execution environment hai js ka.

- bahut sare engines rhte hai for the execution of js, such as the V8 engine, yeh core js ka engine hai jo ki entirely c++ mei likha gya hai.
- actually mei js run cpp se hota hai, python also, kypki core language toh woi hai, baaki sab languages uske upar ek wrapper bnke use hote hai. 

- v8 engine deta hai yeh sab debugging tools, apis and methods, so console.log bhi actually mei v8 engine ka pert hai, js ka runtime deta hai. 
